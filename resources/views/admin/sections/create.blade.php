...
<body class="bg-gray-100 flex">
  ...
  <div>
    ...
    <input type="text" id="subtitle" name="subtitle" placeholder="Contoh: Hidangan Tradisional"
      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
  </div>
  ...
  <div>
    ...
    <textarea id="short_description" name="short_description" rows="3"
      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
      placeholder="Deskripsikan secara singkat isi section ini..."></textarea>
  </div>

  <!-- Cover Image -->
  <div>
    <label for="cover_image" class="block text-sm font-medium text-gray-700 mb-1">Foto Cover</label>
    <input type="file" id="cover_image" name="cover_image"
      class="w-full border border-gray-300 rounded-lg px-3 py-2 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-red-700 file:text-white hover:file:bg-red-600" accept="image/*">
  </div>
