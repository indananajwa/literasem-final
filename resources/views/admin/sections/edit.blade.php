              ...
              <tbody class="text-gray-700">
                ...
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="py-2 border-t border-gray-200">
                    <input type="radio" name="rule_{{ $key }}" value="required" {{ ($fieldRules[$key] ?? '') == 'required' ? 'checked' : '' }} required>
                  </td>
                  <td class="py-2 border-t border-gray-200">
                    <input type="radio" name="rule_{{ $key }}" value="optional" {{ ($fieldRules[$key] ?? '') == 'optional' ? 'checked' : '' }}>
                  </td>
                  <td class="py-2 border-t border-gray-200">
                    <input type="radio" name="rule_{{ $key }}" value="none" {{ ($fieldRules[$key] ?? '') == 'none' ? 'checked' : '' }}>
                  </td>
                </tr>
                @endforeach
              </tbody>
